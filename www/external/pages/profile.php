...
$query = "SELECT e.nom_examen, T.date_analyse
            FROM (SELECT e.id_examen, ag.date_analyse_generale as date_analyse
                    ...
                    WHERE ag.id_prelevement in (SELECT p.id_prelevement FROM disn1imh_v13_prelevement p WHERE p.id_patient = :id_patient)
                    UNION ALL
                    ...
                    WHERE ac.id_prelevement in (SELECT p.id_prelevement FROM disn1imh_v13_prelevement p WHERE p.id_patient = :id_patient)
                    UNION ALL
                    ...
                    WHERE agl.id_prelevement in (SELECT p.id_prelevement FROM disn1imh_v13_prelevement p WHERE p.id_patient = :id_patient)
                    UNION ALL
                    ...
                    WHERE ah.id_prelevement in (SELECT p.id_prelevement FROM disn1imh_v13_prelevement p WHERE p.id_patient = :id_patient)
                    UNION ALL
                    ...
                    WHERE avd.id_prelevement in (SELECT p.id_prelevement FROM disn1imh_v13_prelevement p WHERE p.id_patient = :id_patient)
                ) T
